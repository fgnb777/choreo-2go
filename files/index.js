...
const UUID = process.env.UUID || 'cbac5b40-d3a6-440f-99d2-fe8a6871ea00'; //若需要改UUID，需要在config.json里改为一致
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'QCYRa5UnhgafFLbtXm';   // 没用哪吒，把这个参数空着
